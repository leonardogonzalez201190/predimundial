...
function getPayloadConfigFromPayload(
  ...
  const typedPayload = payload as PayloadWithDataKey;
  const payloadPayload = typedPayload.payload;
  
  let configLabelKey: string = key;

  if (key in typedPayload && typeof typedPayload[key as keyof typeof typedPayload] === 'string') {
    const value = typedPayload[key as keyof typeof typedPayload];
    configLabelKey = String(value);
  } else if (
    payloadPayload &&
